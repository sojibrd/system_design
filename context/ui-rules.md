...
1. **Per-Route Static Generation (SSG):** সাইটের রুটগুলো (রোডম্যাপ ও সিমুলেশন) বিল্ড-টাইমে স্ট্যাটিকভাবে জেনারেট হয়।
2. **Chunk Splitting:** প্রতিটি সিমুলেশনের পূর্ণ ডেটা (~১৫০KB+) আলাদা চাঙ্ক হিসেবে dynamic import-এর মাধ্যমে লোড হয়।
3. **Read-Only Data:** `docs/` ফাইলগুলো সম্পূর্ণ read-only।
