...
| 11 | Load balancer / horizontal scaling | [১১](https://sojibrd.github.io/system_design_roadmap/docs/11-load-balancers/) | ○ একাধিক app server লাগছে (peak QPS > ~১০০, বা #10 from) |
...
- উত্তর শুনে পরেরটায় যান। কোনো উত্তর অন্য সিদ্ধান্তকে অপ্রাসঙ্গিক করলে কোনটা বাদ গেল তা বলুন
